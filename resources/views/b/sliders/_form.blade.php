      ...
      <div class="x_content">
        <div class="form-group">
          ...
          <div class='input-group date' id='datetimepicker1'>
            {!! Form::text('start_at', null, ['id' => 'published_at', 'class' => 'form-control', 'placeholder' => 'Y-m-d H:i:s']) !!}
        ...
        <div class='input-group date' id='datetimepicker2'>
          {!! Form::text('finish_at', null, ['id' => 'published_at', 'class' => 'form-control', 'placeholder' => 'Y-m-d H:i:s']) !!}
          <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
          </span>
        </div>
